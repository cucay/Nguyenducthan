...
public class CartItemModel {
    ...
    public CartItemModel(int type, int productImage, String prodcutTitle, int freeCoupens, String productPrice, String cuttedPrice, int productQuantity, int offersApplied, int coupensApplied) {
        this.type = type;
