...
public class GridProductLayoutAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView==null){
            ...
            TextView productDescaption=view.findViewById(R.id.h_s_product_descaption);
            TextView productPrice=view.findViewById(R.id.h_s_product_price);

            productImage.setImageResource(horizontalProductScrollModelList.get(position).getProductImage());
            productTitle.setText(horizontalProductScrollModelList.get(position).getProductTitle());
            productDescaption.setText(horizontalProductScrollModelList.get(position).getProductDescription());
