...
public class HomePageAdapter extends RecyclerView.Adapter{
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        switch (viewType){
            ...
            case HomePageModel.HORIZONTAL_PRODUCT_VIEW:
                View horozontalProductView= LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.horizontal_scroll_layout,viewGroup,false);
                return new HorizontalProductViewhoder(horozontalProductView);
            case HomePageModel.GRID_PRODUCT_VIEW:
                ...
                return new GirdProductViewHolder(girdProductView);
                default:
                    return null;
        }
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
        switch (homePageModelList.get(position).getType()){
            ...
            case HomePageModel.HORIZONTAL_PRODUCT_VIEW:
                ...
                ((HorizontalProductViewhoder)viewHolder).setHorizontalProductLayout(horizontalProductScrollModelList,horizontalLayoutTitle);
                break;
            case HomePageModel.GRID_PRODUCT_VIEW:
                String girdLayoutTitle=homePageModelList.get(position).getTitle();
                List<HorizontalProductScrollModel> gridProductScrollModelList=homePageModelList.get(position).getHorizontalProductScrollModelList();
                ((GirdProductViewHolder)viewHolder).setGridProductLayout(gridProductScrollModelList,girdLayoutTitle);
                default:
                    return;
        }
    }
    ...
    public class StripAdBannerViewholder extends RecyclerView.ViewHolder{
        ...
        private void setStripAd(int resource,String color){
           // Glide.with(itemView.getContext()).load(resource).apply(new RequestOptions().placeholder(R.mipmap.profile)).into(stripAdImage);
    ...
    public class  GirdProductViewHolder extends RecyclerView.ViewHolder{
        private TextView gridLayoutTitle;
        private Button gridLayoutViewAllBtn;
        private GridView gridView;

        public GirdProductViewHolder(@NonNull View itemView) {
            super(itemView);
           gridLayoutTitle=itemView.findViewById(R.id.grid_product_layout_title);
            gridLayoutViewAllBtn=itemView.findViewById(R.id.grid_product_layout_viewall_btn);
             gridView=itemView.findViewById(R.id.grid_product_layout_girdview);
        }
